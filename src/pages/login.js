        ...
        <main className="w-full h-screen flex flex-col items-center justify-center bg-gray-200">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-2/5 h-1/3 flex flex-col justify-center">
                ...
                <div className="flex justify-end">
                    <button className="bg-blfs-teal hover:bg-blfs-blue text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Sign in</button>
                </div>
            </form>
        </main>
        </>
