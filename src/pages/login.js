      ...
      <main className="w-full min-h-screen flex flex-col items-center justify-center bg-gray-200">
        ...
        >
          ...
          <div className="w-full flex flex-col-reverse gap-2 sm:gap-0 sm:flex-row justify-between items-center px-8">
            <Link href="/register" className="text-xs text-secondary underline">
              Create your account
            </Link>
            ...
            <button
              ...
              className="w-40 bg-secondary hover:bg-primary text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="submit"
            >
              {isSubmitting ? (
                <ClipLoader
