...
export default function SyrupOption({ options, additionalSyrup=0, updateDrink, addAdditionalSyrup, subtractAdditionalSyrup, selectedDrink, numOfAdditionalSyrups }) {
    ...
    return (
        <div className="w-full flex flex-col flex-nowrap my-2 items-center z-9">
        <div className="w-full flex flex-nowrap justify-between items-center relative z-9">
            ...
            <div className="flex flex-nowrap flex-row items-center">
                ...
                <Listbox value={selectedOption} onChange={handleChange}>
                    <Listbox.Button className="z-5 border text-xl pr-1 pl-3 py-1 rounded flex flex-nowrap justify-between items-center gap-3">
