...
export default function DashboardOption({ title, destination, bgColor, bgHover }) {
    ...
    return (
        <div className={`w-90 h-24 mx-5 sm:w-52 sm:h-52 sm:px-10 sm:aspect-square flex justify-center items-center rounded shadow-md m-2 hover:cursor-pointer ` + backgroundColor } onClick={handleClick}>
